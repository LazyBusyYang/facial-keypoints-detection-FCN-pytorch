...
# parser.add_argument('--resume', default="/home1/gaoyang/models/Facial_FCN/checkpoint_353.pth.tar", type=str, metavar='PATH', help='path to latest checkpoint (default: none)')
